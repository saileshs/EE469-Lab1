...
add wave -noupdate -label IDEX_data1_in /cpu_pipelined_testbench/dut/reg2/read_data1_in
add wave -noupdate -label IDEX_data2_in /cpu_pipelined_testbench/dut/reg2/read_data2_in
add wave -noupdate -label IDEX_data1_out /cpu_pipelined_testbench/dut/reg2/read_data1_out
add wave -noupdate -label IDEX_data2_out /cpu_pipelined_testbench/dut/reg2/read_data2_out
add wave -noupdate -expand -group RegFile -radix unsigned /cpu_pipelined_testbench/dut/rf/ReadData1
add wave -noupdate -expand -group RegFile -radix unsigned /cpu_pipelined_testbench/dut/rf/ReadData2
add wave -noupdate -expand -group RegFile -radix unsigned /cpu_pipelined_testbench/dut/rf/ReadRegister1
add wave -noupdate -expand -group RegFile -radix unsigned /cpu_pipelined_testbench/dut/rf/ReadRegister2
add wave -noupdate -expand -group RegFile -radix unsigned /cpu_pipelined_testbench/dut/rf/WriteRegister
add wave -noupdate -expand -group RegFile -radix unsigned /cpu_pipelined_testbench/dut/rf/WriteData
add wave -noupdate -expand -group RegFile -radix unsigned /cpu_pipelined_testbench/dut/rf/RegWrite
add wave -noupdate -expand -group RegFile -radix unsigned /cpu_pipelined_testbench/dut/rf/clk
add wave -noupdate -expand -group RegFile -radix unsigned /cpu_pipelined_testbench/dut/rf/registerOutput
add wave -noupdate -expand -group RegFile -radix unsigned /cpu_pipelined_testbench/dut/rf/enableRegister
add wave -noupdate -expand -group RegFile -radix unsigned /cpu_pipelined_testbench/dut/rf/reset
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 2} {687055167 ps} 0}
...
update
WaveRestoreZoom {0 ps} {1330851304 ps}
